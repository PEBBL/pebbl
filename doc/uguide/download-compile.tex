...
undertanding PEBBL's execution path and decision making.  If this option is
not specified, the debugging output macros become stubs during compiler
preprocessing.  See Section~\ref{sec:debugOutput} for a discussion of how to
use these macros in your own application code. Section~\ref{sec:debugparams}
