...
If you did perform the \texttt{make install} step, you may specify the install
...
Note that \texttt{DEBUGPR} and the other macros described in this section will
...
\texttt{MPI\_COMM\_WORLD}.  This constructor should call the no-argument constructor for your serial application class, such as
